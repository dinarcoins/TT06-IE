training = new (function () {
  this.cấuHình = function (W) {
    ...
    H.bảng(
      ...
      {
        // Cấu hình chung
        tiêuĐề: "Training - BQT bài viết", // Tiêu đề bảng
      ...
      function () {
        ...
        CẦN.db(["chuyênMục.10086", "chuyênLực.10086"], function () {
          C.find(".bộLọc")
            .empty()
            .append(
              $("<div>", { class: "fs08-xs cb fwn" }).append(
                $("<div>", { class: "dưới flex jcsc col-xs-12" }).append(
                  ...
                  $("<div>", { class: "bgcf ma5 bra3 khối" }).append(
                    $("<div>", {
                      id: "ụ",
                      class: "h1 bgcf bn dnb wsn els ma0 koNhãn lấyĐc",
                    }).sổ(
                      (config("chuyênLực.10086") || []).map(function (á) {
